...
class WordListAdapter internal constructor(
    ...
    private var words = emptyList<BalanceRoom>() // Cached copy of words
    ...
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) {
        ...
        holder.wordItemView.text = current.currentBalance
    }

    internal fun setWords(words: List<BalanceRoom>) {
        this.words = words
